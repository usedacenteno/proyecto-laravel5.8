        ...
        <div class="col-lg-12">
            ...
            <div class="box box-danger">
                <div class="box-header with-border">
                    ...
                    <a href="{{route('vista_proveedor')}}" class="btn btn-info btn-sm pull-right">Listado</a>
                </div>
            </div>
        </div>
</div> 
    <form action="{{route('actualizar_proveedor', ['id'=>$data->id])}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off" >
         @method("PUT")
         @csrf 
         <div class="row">
