        ...
        <div class="col-lg-12">
            ...
            <div class="box box-danger">
                <div class="box-header with-border">
                    ...
                    <a href="{{route('vista_proveedor')}}" class="btn btn-info btn-sm pull-right"> Volver</a>
                </div>
            </div>
        </div>
</div>    
<form action="{{route('guardar_proveedor')}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
   <div class="row">
